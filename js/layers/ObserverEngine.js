/*
* This class is the driving engine behind the the MVC pattern used in this application
...
var ObserverEngine = ( function( window, undefined ) {
  ...
  ObserverEngine.prototype.observe = function observeObject( obj ) {
    // console.log( 'added new observer' );
    this._list.push( obj );
  };
  
  ObserverEngine.prototype.unobserve = function unobserveObject( obj ) {
  ...
  ObserverEngine.prototype.notify = function notifyObservers() {
